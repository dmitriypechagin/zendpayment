...
return array(
	...
	"The two given tokens do not match" => "Значения не идентичные",
    ...
    BalanceRow::NO_VALID_PURSE => "Кошелек '%value%' не существует",
    "No more than three alphabetic Latin characters" => "Не более трех буквенных латинских символов",
);
