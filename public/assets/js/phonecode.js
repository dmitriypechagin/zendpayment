    ...
    $.widget('custom.phonecode', {
        ...
        _loadData : function() {
            ...
            if(!countryCache && !countryRequesting) {
                countryRequesting = $.getJSON('/cp/public/assets/js/countries.json', {})
                    .done(function(json) {
                        self.data = json;
        ...
        _initSelector: function() {
            ...
            for(var i = 0; i < this.data.length; i++) {
                ...
                var option = $('<div data-phone="'+
                    ...
                    ' class="country-phone-option"><span>+'+ country.ph +'<img src="/cp/public/assets/images/blank.gif" class="flag flag-'+
                    country.co +
                    '"></span>'+ country.na +'</div>'
                );
            ...
            if(selected) {
                this.container.find('.country-phone-selected')
                    .html('<img src="/cp/public/assets/images/blank.gif" class="flag flag-'+ selected.co +'">+'+ selected.ph);
            }
