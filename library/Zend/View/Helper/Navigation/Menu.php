    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    public function htmlify(Zend_Navigation_Page $page)
    {
		...
		if ($href == '/cp/account/support') {
			
			return '<li class="' . $href . '"><' . $element . ' href="/support">'
			 . '<div class="item-content">'
			 . '<div class="item-media">'	
			 . '<i class="fa ' . $this->view->escape($text[1]) . '"></i>'
			 . '</div>'
			 . '<div class="item-inner">'
			 . '<span class="title"> ' . $this->view->escape($text[0]) . ' </span>'
			 . '</div>'
			 . '</div>'
             . '</' . $element . '></li>';
		}
		else {
			return '<li class="' . $href . '"><' . $element . $this->_htmlAttribs($attribs) . '>'
			 . '<div class="item-content">'
			 . '<div class="item-media">'	
			 . '<i class="fa ' . $this->view->escape($text[1]) . '"></i>'
			 . '</div>'
